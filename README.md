...
{
    Console.WriteLine("?? Incompatible mods detected:");
...
if (incompatibilities.Count > 0)
{
    Console.WriteLine("?? This mod is incompatible with:");
...
{
    Console.WriteLine("?? No obvious problematic mods identified in crash report.");
...
{
    Console.WriteLine($"\n?? Also check missing dependencies for {missingDeps.Count} mods");
}
...
class Program
{
    static void Main()
    {
        ...
        Console.WriteLine($"\n?? Conflicts: {conflicts.Count} duplicates, {incompatibilities.Count} incompatibilities");
